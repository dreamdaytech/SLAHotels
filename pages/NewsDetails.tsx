...
const NewsDetails: React.FC = () => {
  ...
  if (appLoading && !article) return (
    <div className="pt-24 sm:pt-32 lg:pt-40 pb-40 text-center text-slate-400">
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-end overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 pb-10 sm:pb-16 md:pb-20">
          <div className="max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white leading-tight tracking-tighter">
              {article.title}
            </h1>
          </div>
        </div>
      ...
      <div className="border-b border-slate-100 bg-slate-50/50">
        <div className="container mx-auto px-4 md:px-8 py-5 sm:py-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
